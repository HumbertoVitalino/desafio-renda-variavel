...
{
    private readonly NewUserUseCase _useCase;
    private readonly Mock<IUserRepository> _repositoryMock;
    private readonly Mock<IPasswordService> _passwordServiceMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly Mock<ILogger<NewUserUseCase>> _loggerMock;
    ...
    public NewUserTest()
    {
        ...
        _loggerMock = new Mock<ILogger<NewUserUseCase>>();
        _useCase = new NewUserUseCase(_repositoryMock.Object, _passwordServiceMock.Object, _unitOfWorkMock.Object, _loggerMock.Object);
    }
